...
// $('body').append('' +
//     '<div class="fixed-button">' + '<a href="https://appseed.us/boilerplate-code/flask-dashboard" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-file" aria-hidden="true"></i> Product Page' +
//     '</a> ' + '</div>' + '');
var $window = $(window);
